...
public class ExampleApplication {
 ...
 /*     if (args.length == 2) {
      ...
      taeDescriptor=new File("C:\\uima-as-2.6.0-bin\\examples\\descriptors\\analysis_engine\\SimpleNameRecognizer_RegEx_TAE.xml");
      inputDir=new File("C:\\uima-as-2.6.0-bin\\examples\\data");
      if (!validArgs) {
        printUsageMessage();
      } else {
